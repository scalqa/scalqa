 ...
 *  [[scalqa.Stream._iterate._Trait iterate]], [[scalqa.Stream._consume._Trait consume]], and [[scalqa.Stream._info._Trait info]] traits.  Some of those traits is split further.
