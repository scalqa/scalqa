...
class Line extends Shape:
  ...
  @tn("startX_Pro") def startX_*                        : Double.Pro.OM   = Fx.JavaFx.To.pro_OM(real.startXProperty)
  /**/              def startX                          : Double          = real.getStartX
  /**/              def startX_=(b: Double)             : Unit            = real.setStartX(b)
  @tn("startY_Pro") def startY_*                        : Double.Pro.OM   = Fx.JavaFx.To.pro_OM(real.startYProperty)
  /**/              def startY                          : Double          = real.getStartY
  /**/              def startY_=(b: Double)             : Unit            = real.setStartY(b)
  @tn("endX_Pro")   def endX_*                          : Double.Pro.OM   = Fx.JavaFx.To.pro_OM(real.endXProperty)
  /**/              def endX                            : Double          = real.getEndX
  /**/              def endX_=(b: Double)               : Unit            = real.setEndX(b)
  @tn("endY_Pro")   def endY_*                          : Double.Pro.OM   = Fx.JavaFx.To.pro_OM(real.endYProperty)
