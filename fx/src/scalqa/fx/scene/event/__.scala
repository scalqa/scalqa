...
object Event:
  type Control     = Gen.Event.Control;    inline def Control     = Gen.Event.Control
  type Id          = Gen.Event.Id;         inline def Id          = Gen.Event.Id
  type Store       = Gen.Event.Store;      inline def Store       = Gen.Event.Store
