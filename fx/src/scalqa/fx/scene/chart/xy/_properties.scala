...
transparent trait _properties[X,Y]:
  ...
  @tn("alternativeColumnFillVisible_Pro") def alternativeColumnFillVisible_*              : Boolean.Pro.OM  = Fx.JavaFx.As.pro_OM(real.alternativeColumnFillVisibleProperty)
  ...
  @tn("alternativeRowFillVisible_Pro")    def alternativeRowFillVisible_*                 : Boolean.Pro.OM  = Fx.JavaFx.As.pro_OM(real.alternativeRowFillVisibleProperty)
  ...
  @tn("horizontalGridLinesVisible_Pro")   def horizontalGridLinesVisible_*                : Boolean.Pro.OM  = Fx.JavaFx.As.pro_OM(real.horizontalGridLinesVisibleProperty)
  ...
  @tn("horizontalZeroLineVisible_Pro")    def horizontalZeroLineVisible_*                 : Boolean.Pro.OM  = Fx.JavaFx.As.pro_OM(real.horizontalZeroLineVisibleProperty)
  ...
  @tn("verticalGridLinesVisible_Pro")     def verticalGridLinesVisible_*                  : Boolean.Pro.OM  = Fx.JavaFx.As.pro_OM(real.verticalGridLinesVisibleProperty)
  ...
  @tn("verticalZeroLineVisible_Pro")      def verticalZeroLineVisible_*                   : Boolean.Pro.OM  = Fx.JavaFx.As.pro_OM(real.verticalZeroLineVisibleProperty)
