package scalqa; package fx; package scene; package chart; package axis; package as; package time; package z; import language.implicitConversions

import Gen.{ Time, DayTime, Year }

class Gauge(tu: Time.Length, mc: Int) extends As.Time.Gauge(tu, mc):
...
object Gauge:
  // **********************************************************************************
  class Month(count: Int, minor: Int) extends As.Time.Gauge((30 * count).Days, minor):
  ...
  // **********************************************************************************
  class Year(count: Int, minor: Int) extends As.Time.Gauge((count * 56).Weeks, minor):
