...
object Event:
  private[scalqa] type Id      = gen.event.Id;       private[scalqa] transparent inline def Id          = gen.event.Id
  private[scalqa] type Control = gen.event.Control;  private[scalqa] transparent inline def Control     = gen.event.Control
  private[scalqa] type Store   = gen.event.Store;    private[scalqa] transparent inline def Store       = gen.event.Store
