...
object Insets extends Abstract.Delegate.Opaque[Util.Insets, JInsets]("Fx.Insets"):
  ...
  override def info(v: Insets) = Info(name) += ("top", v.top) += ("bottom", v.bottom) += ("left", v.left) += ("right", v.right)
