...
object List:
  ...
  def createChange[A](in: Idx[Idx.O.Event[A]], o: JFX.ObservableList[A]): JFX.ListChangeListener.Change[A] & Able.Info = change.Change(in, o)
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  // ---------------------------------------------------------------------------------------------------------------------------------------------------------------
  def singleChangeDoc[A](c: JFX.ListChangeListener.Change[A]): Info =
