...
transparent trait _onKey:
  ...
  def onKeyPressed [U](l: Ui.Event.Key => U) : Gen.Event.Control = Ui.Event.Key.subscribe(self, l, real.onKeyPressedProperty)
  def onKeyReleased[U](l: Ui.Event.Key => U) : Gen.Event.Control = Ui.Event.Key.subscribe(self, l, real.onKeyReleasedProperty)
  def onKeyTyped   [U](l: Ui.Event.Key => U) : Gen.Event.Control = Ui.Event.Key.subscribe(self, l, real.onKeyTypedProperty)
