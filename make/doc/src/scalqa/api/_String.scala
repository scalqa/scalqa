...
trait _String:
  ...
  extension (x: String)
    ...
    def simpleName: String =
      ...
      n = n.d("Def.").d("Gen.").d("Val.")
           .d("Any.Ref",4).d("Any.Raw",4).d("Any.Opaque",4).d("Any.Self.Info",9).d("Any.Self.Shape",9).d("Any.Self.Void",9)
      ...
      n = n.r("Root.Package.").r(".G.Util.",".G.").r("Event.Observable","Observable").r("Fx.Control.","Fx.").r("Fx.Scene.","Fx.").r("Fx.Event.Control","Event.Control").r("__.Package.")
           .r(".Custom.Framework.Companion.",".").r(".Custom.Framework.",".").r("THIS_TYPE","this.type")
      ...
      n = n match{case "Boolean.Raw" => "Raw.Boolean"; case "Byte.Raw" => "Raw.Byte"; case "Char.Raw"  => "Raw.Char";  case "Short.Raw"  => "Raw.Short";
                  case "Int.Raw"     => "Raw.Int";     case "Long.Raw" => "Raw.Long"; case "Float.Raw" => "Raw.Float"; case "Double.Raw" => "Raw.Double"; case n => n}
      //var i = n.indexOf("._");
