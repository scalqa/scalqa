...
trait _compare[TYPE <: _compare[TYPE]] extends Any with Any.Datum.Comparable[TYPE, java.math.BigDecimal] with math.Ordered[TYPE] with Any.Datum.Z.Number.Compare {
