package scalqa; package Util; package EventControl; package A

abstract class Base protected extends java.util.concurrent.atomic.AtomicReference[Array[() => Boolean]](Base.Void) with EventControl {
