...
object copySize:
  ...
  inline def apply[A,ARRAY<:Any[A]](inline x: ARRAY, inline sz: Int, inline t: Tag[A,ARRAY]): ARRAY =
    inline t match
              case _ : Tag[A&Raw.Boolean,Array[A&Raw.Boolean]] => Arrays.copyOf(x.cast[Array[Boolean]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Byte,   Array[A&Raw.Byte   ]] => Arrays.copyOf(x.cast[Array[Byte   ]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Char,   Array[A&Raw.Char   ]] => Arrays.copyOf(x.cast[Array[Char   ]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Short,  Array[A&Raw.Short  ]] => Arrays.copyOf(x.cast[Array[Short  ]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Int,    Array[A&Raw.Int    ]] => Arrays.copyOf(x.cast[Array[Int    ]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Long,   Array[A&Raw.Long   ]] => Arrays.copyOf(x.cast[Array[Long   ]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Float,  Array[A&Raw.Float  ]] => Arrays.copyOf(x.cast[Array[Float  ]],sz).cast[ARRAY]
              case _ : Tag[A&Raw.Double, Array[A&Raw.Double ]] => Arrays.copyOf(x.cast[Array[Double ]],sz).cast[ARRAY]
              case _ : Tag[A&Ref,        Array[A&Ref        ]] => Arrays.copyOf(x.cast[Array[Ref    ]],sz).cast[ARRAY]
