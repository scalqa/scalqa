package scalqa; package `def`; package byte; package custom; package data; import language.implicitConversions

import scala.{ Byte as REAL }
import java.lang.{ Byte as NUMBER }

abstract class Number[A<:Opaque.Byte](typeName:String) extends Ordered[A](typeName):

  @fast given math: G.Math[A] = Def.Byte.math.cast[G.Math[A]]
