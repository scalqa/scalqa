...
trait Collection[A<:RAW] extends Val.Collection[A] with Able.Contain[A] with any.self.info.Specialized.OnByte:
...
object Collection:
  ...
  object StableSet:
    ...
    implicit inline def xxRequest[A<:RAW](inline v: \/): StableSet[A] = zVoid.cast[StableSet[A]]
