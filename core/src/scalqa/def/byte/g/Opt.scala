package scalqa; package `def`; package byte; package g; import language.implicitConversions; import G.Opt
...
object Opt extends z.opt._base:
  ...
  object opaque { opaque type `type`[+A<:RAW] <: Opaque.Short = Short & Opaque.Short }
