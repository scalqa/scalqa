package scalqa; package `def`; package boolean; package g; import language.implicitConversions

abstract class Stream[A<:RAW] extends Val.~[A] with ~~.Custom.Discharge[A] with any.self.info.Specialized.OnBoolean:
  self =>
