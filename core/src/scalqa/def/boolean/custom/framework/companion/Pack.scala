package scalqa; package `def`; package boolean; package custom; package framework; package companion; import language.implicitConversions

class Pack[A<:RAW] private[`def`]() extends Pack.zBased[A,G.><[A]]
