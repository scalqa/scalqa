package scalqa; package `def`; package short; package g; import language.implicitConversions; import G.Opt
...
object Opt extends z.opt._base:
  ...
  extension[A<:RAW](x: Opt[A])
    /**/               inline def ref                                         : Val.Opt[A] = (if(x.isEmpty) ZZ.None else java.lang.Short.valueOf(x.real.Short)).cast[Val.Opt[A]]
