...
transparent private[z] trait tp :
  ...
  extension[A<:Any.Raw.Boolean](inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Byte]   (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Char]   (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Short]  (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Int]    (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Long]   (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Float]  (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)
  extension[A<:Any.Raw.Double] (inline x:A) inline def tp (using inline t:Tag[A]) : Unit   = ZZ.tp(x.real,t)

  extension[A]                 (inline x:A) inline def TP(using inline dt:Tag[A]) : Unit   = ZZ.tp(x,dt)
