...
object Doc:
  inline given xxDefault[A]: Doc[A]          = ZZ.Tag
  inline given xxBoolean   : Doc[Boolean]    = ZZ.BooleanTag.cast[Doc[Boolean]]
  inline given xxByte      : Doc[Byte]       = ZZ.ByteTag.cast[Doc[Byte]]
  inline given xxChar      : Doc[Char]       = ZZ.CharTag.cast[Doc[Char]]
  inline given xxShort     : Doc[Short]      = ZZ.ShortTag.cast[Doc[Short]]
  inline given xxInt       : Doc[Int]        = ZZ.IntTag.cast[Doc[Int]]
  inline given xxLong      : Doc[Long]       = ZZ.LongTag.cast[Doc[Long]]
  inline given xxFloat     : Doc[Float]      = ZZ.FloatTag.cast[Doc[Float]]
  inline given xxDouble    : Doc[Double]     = ZZ.DoubleTag.cast[Doc[Double]]
  inline given xxArray[A]  : Doc[Array[A]]   = ZZ.ArrayTag.cast[Doc[Array[A]]]
  inline given xxMath[A]   : Doc[Math[A]]    = ZZ.MathTag.cast[Doc[Math[A]]]
