package scalqa; package `def`; package double; package custom; package data; import language.implicitConversions

import scala.{ Double as REAL }

abstract class Numerical[A<:Opaque.Double](typeName:String) extends Ordered[A](typeName):
