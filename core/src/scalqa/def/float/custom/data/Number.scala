package scalqa; package `def`; package float; package custom; package data; import language.implicitConversions
...
abstract class Number[A<:Opaque.Float](typeName:String) extends Ordered[A](typeName):
  ...
  @fast given math: G.Math[A] = Def.Float.math.cast[G.Math[A]]
