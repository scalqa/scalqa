package scalqa; package `def`; package long; package custom; package data; import language.implicitConversions

import scala.{ Long as REAL }
import java.lang.{ Long as NUMBER }

abstract class Number[A<:Opaque.Long](typeName:String) extends Ordered[A](typeName):

  @fast given math: G.Math[A] = Def.Long.math.cast[G.Math[A]]
