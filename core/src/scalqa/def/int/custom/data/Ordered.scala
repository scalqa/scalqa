package scalqa; package `def`; package int; package custom; package data; import language.implicitConversions

abstract class Ordered[A<:Opaque.Int](typeName:String) extends Data[A](typeName):
