package scalqa; package `def`; package int; package g; import language.implicitConversions; import G.Opt

object Opt extends z.opt._base:
  @tn("getVoid") inline def void[A<:RAW]                             : Opt[A]  = 3_000_000_000L.cast[Opt[A]]  // Smallest round number
  implicit       inline def xxRequest [A<:RAW](inline v: Request.\/) : Opt[A]  = void[A]
