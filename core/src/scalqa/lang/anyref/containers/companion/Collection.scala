package scalqa; package lang; package anyref; package containers; package companion; import language.implicitConversions
...
class Collection[A]:
  ...
  object Mutable:
    def apply(initSize: Int = J.initSize): Mutable = new AnyRef.Buffer(initSize).cast[Mutable]
