...
object Calculable:
  ...
  transparent trait _methods extends Ordered._methods:
    extension[THIS_OPAQUE <: Opaque](inline x: THIS_OPAQUE)
      ...
      @tn("multiply") inline def *(inline v: Byte|Short|Int): THIS_OPAQUE  = (x.real * v.cast[Int]).cast[THIS_OPAQUE]
      @tn("divide")   inline def /(inline v: Byte|Short|Int): THIS_OPAQUE  = (x.real / v.cast[Int]).cast[THIS_OPAQUE]
...
___________________________________________________________________________*/
/**
@class Calculable -> ### Int Opaque Calculable Data Companion Object Base
  ...
  See [sample type definition](https://github.com/scalqa/samples/blob/master/src/example/opaque/all/CalculableIntData.scala).

@trait _methods -> Default methods for all Int.Opaque.Data.Calculable defined types
