...
object Numerical:
  ...
  transparent trait _methods extends Data._methods with Ordered.z_MethodsBase:
    extension[THIS_OPAQUE <: Opaque](inline x: THIS_OPAQUE)
      ...
      @tn("multiply")       inline def * (inline v: THIS_OPAQUE|Byte|Short|Int)                  : THIS_OPAQUE       = (x.real * v.cast[Int]).cast[THIS_OPAQUE]
      @tn("divide")         inline def / (inline v: THIS_OPAQUE|Byte|Short|Int)                  : THIS_OPAQUE       = (x.real / v.cast[Int]).cast[THIS_OPAQUE]
      @tn("plus")           inline def + (inline v: THIS_OPAQUE|Byte|Short|Int)                  : THIS_OPAQUE       = (x.real + v.cast[Int]).cast[THIS_OPAQUE]
      @tn("minus")          inline def - (inline v: THIS_OPAQUE|Byte|Short|Int)                  : THIS_OPAQUE       = (x.real - v.cast[Int]).cast[THIS_OPAQUE]
      @tn("remainder")      inline def % (inline v: THIS_OPAQUE|Byte|Short|Int)                  : THIS_OPAQUE       = (x.real % v.cast[Int]).cast[THIS_OPAQUE]
      @tn("greater")        inline def > (inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean           = inline v match{ case _ :Double => x.real >  v.cast[Double]; case _ :Float => x.real >  v.cast[Float]; case _ :Long => x.real >  v.cast[Long]; case _ => x.real >  v.cast[Int] }
      @tn("greaterOrEqual") inline def >=(inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean           = inline v match{ case _ :Double => x.real >= v.cast[Double]; case _ :Float => x.real >= v.cast[Float]; case _ :Long => x.real >= v.cast[Long]; case _ => x.real >= v.cast[Int] }
      @tn("less")           inline def < (inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean           = inline v match{ case _ :Double => x.real <  v.cast[Double]; case _ :Float => x.real <  v.cast[Float]; case _ :Long => x.real <  v.cast[Long]; case _ => x.real <  v.cast[Int] }
      @tn("lessOrEqual")    inline def <=(inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean           = inline v match{ case _ :Double => x.real <= v.cast[Double]; case _ :Float => x.real <= v.cast[Float]; case _ :Long => x.real <= v.cast[Long]; case _ => x.real <= v.cast[Int] }
...
___________________________________________________________________________*/
/**
@class Numerical -> ### Int Opaque Numerical Data Companion Object Base
  ...
  See [sample type definition](https://github.com/scalqa/samples/blob/master/src/example/opaque/all/NumericalIntData.scala).

@trait _methods -> Default methods for all Int.Opaque.Data.Numerical defined types
