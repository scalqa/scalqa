...
transparent trait Framework[A<:RAW]:
  ...
  inline def emptyArray: Array[A] = ZZ.emptyIntArray.cast[Array[A]]
...
___________________________________________________________________________*/
/**
@trait Framework -> ### Raw Int Customized Containers
...
@type StableSet  ->  Type alias \n\n Shortcut to [[scalqa.lang.Int$.Collection.StableSet Collection.StableSet]]
