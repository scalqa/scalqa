...
object Custom:
  type Type[A<:Opaque.Int]  = custom.Type[A];        transparent inline def Type       = custom.Type
  type Data[A<:Opaque.Int]  = custom.Data[A];        transparent inline def Data       = custom.Data
