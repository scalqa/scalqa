...
object Opt:
  ...
  implicit       inline def implicitFromAnyInt[A<:Raw](inline v: A)           : Opt[A]     = v.cast[Opt[A]]
  ...
  extension[A<:Raw](inline x: Opt[A])
    ...
    /**/  inline def ref                                         : Val.Opt[A] = {val X=x; if(X.isEmpty) ZZ.None else java.lang.Integer.valueOf(X.real.toInt)}.cast[Val.Opt[A]]
...
___________________________________________________________________________*/
/**
@type DEF -> ### Int Specialized Generic Option
