...
object Pack:
  ...
  @tn("getVoid")         def void      [A<:Raw]                            : Pack[A] = zVoid.cast[Pack[A]]; private object zVoid extends Pack(Array.emptyInt) with Gen.Void
...
___________________________________________________________________________*/
/**
@class Pack -> ### Int Specialized Generic Pack Collection
