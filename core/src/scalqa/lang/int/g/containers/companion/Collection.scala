package scalqa; package lang; package int; package g; package containers; package companion; import language.implicitConversions
...
private[scalqa] object Collection extends Collection[Int]
