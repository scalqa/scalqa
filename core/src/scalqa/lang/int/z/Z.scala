...
object  Z:
  ...
  object OptEmptyDef extends Any.Def.Void[G.Opt[Int]] with Any.Def.Empty[G.Opt[Int]]:
    def value_isVoid( v:G.Opt[Int]) = v.isEmpty
    def value_isEmpty(v:G.Opt[Int]) = v.isEmpty
