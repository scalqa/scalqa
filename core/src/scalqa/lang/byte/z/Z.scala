...
object  Z:
  ...
  object OptEmptyDef extends Any.Def.Void[G.Opt[Byte]] with Any.Def.Empty[G.Opt[Byte]]:
    def value_isVoid( v:G.Opt[Byte]) = v.isEmpty
    def value_isEmpty(v:G.Opt[Byte]) = v.isEmpty
