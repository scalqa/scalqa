...
object Pack:
  ...
  @tn("getVoid")  inline def void      [A<:Raw]                              : Pack[A] = z_Void.cast[Pack[A]]; object z_Void extends Pack(Array.emptyByte) with Gen.Void
...
___________________________________________________________________________*/
/**
@class Pack -> ### Byte Specialized Generic Pack Collection
