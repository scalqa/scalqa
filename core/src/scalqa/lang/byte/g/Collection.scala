...
trait Collection[A<:Raw] extends Val.Collection[A] with Able.Contain[A] with any.z.PrimitiveTag.Byte:
...
object Collection:
  ...
  object StableSet:
    ...
    implicit inline def implicitFrom[A<:Raw](v: \/): StableSet[A] = zVoid.cast[StableSet[A]]
