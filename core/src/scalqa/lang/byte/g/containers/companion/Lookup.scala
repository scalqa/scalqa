package scalqa; package lang; package byte; package g; package containers; package companion; import language.implicitConversions
...
private[scalqa] object Lookup extends Lookup[Byte]
