...
transparent trait Framework[A<:RAW]:
  ...
  inline def emptyArray: Array[A] = ZZ.emptyByteArray.cast[Array[A]]
...
___________________________________________________________________________*/
/**
@trait Framework -> ### Raw Byte Customized Containers
...
@type StableSet  ->  Type alias \n\n Shortcut to [[scalqa.lang.Byte$.Collection.StableSet Collection.StableSet]]
