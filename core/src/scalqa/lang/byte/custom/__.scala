...
object Custom:
  type Type[A<:Opaque.Byte] = custom.Type[A];        transparent inline def Type       = custom.Type
  type Data[A<:Opaque.Byte] = custom.Data[A];        transparent inline def Data       = custom.Data
