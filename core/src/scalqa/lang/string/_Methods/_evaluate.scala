...
transparent trait _evaluate[A<: String | Opaque.String] :
  ...
  extension(inline x: A)
    ...
    /**/                     inline def contains        (inline v: A|String)                                   : Boolean  = x.real.contains(v)
    /**/                     inline def startsWith      (inline v: A|String)                                   : Boolean  = x.real.startsWith(v)
    /**/                     inline def endsWith        (inline v: A|String)                                   : Boolean  = x.real.endsWith(v)
    /**/                     inline def equalsIgnoreCase(inline v: A|String)                                   : Boolean  = x.real.equalsIgnoreCase(v)
