...
object As:
  ...
  class BooleanStream[A<:Boolean.Raw](a: Array[Boolean], sz: Int) extends Boolean.G.~[A] with Able.Size:
  ...
  class ByteStream[A<:Byte.Raw](a: Array[Byte], sz: Int) extends Byte.G.~[A] with Able.Size:
  ...
  class CharStream[A<:Char.Raw](a: Array[Char], sz: Int) extends Char.G.~[A] with Able.Size:
  ...
  class ShortStream[A<:Short.Raw](a: Array[Short], sz: Int) extends Short.G.~[A] with Able.Size:
  ...
  class IntStream[A<:Int.Raw](a: Array[Int], sz: Int) extends int.G.~[A] with Able.Size:
  ...
  class LongStream[A<:Long.Raw](a: Array[Long], sz: Int) extends Long.G.~[A] with Able.Size:
  ...
  class FloatStream[A<:Float.Raw](a: Array[Float], sz: Int) extends Float.G.~[A] with Able.Size:
  ...
  class DoubleStream[A<:Double.Raw](a: Array[Double], sz: Int) extends Double.G.~[A] with Able.Size:
