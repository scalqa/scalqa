...
object As:
  ...
  class RefStream[A](a: Array[AnyRef], sz: Int) extends ~[A] with Able.Size with ~~.Custom.Discharge[A] with Able.Doc :
  ...
  class BooleanStream[A<:Any.Boolean](a: Array[Boolean], sz: Int) extends Boolean.G.~[A] with Able.Size:
  ...
  class ByteStream[A<:Any.Byte](a: Array[Byte], sz: Int) extends Byte.G.~[A] with Able.Size:
  ...
  class CharStream[A<:Any.Char](a: Array[Char], sz: Int) extends Char.G.~[A] with Able.Size:
  ...
  class ShortStream[A<:Any.Short](a: Array[Short], sz: Int) extends Short.G.~[A] with Able.Size:
  ...
  class IntStream[A<:Any.Int](a: Array[Int], sz: Int) extends int.G.~[A] with Able.Size:
  ...
  class LongStream[A<:Any.Long](a: Array[Long], sz: Int) extends Long.G.~[A] with Able.Size:
  ...
  class FloatStream[A<:Any.Float](a: Array[Float], sz: Int) extends Float.G.~[A] with Able.Size:
  ...
  class DoubleStream[A<:Any.Double](a: Array[Double], sz: Int) extends Double.G.~[A] with Able.Size:
