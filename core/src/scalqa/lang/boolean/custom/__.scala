...
object Custom:
  type Type[A<:Opaque.Boolean] = custom.Type[A];        transparent inline def Type       = custom.Type
  type Data[A<:Opaque.Boolean] = custom.Data[A];        transparent inline def Data       = custom.Data
