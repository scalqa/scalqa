package scalqa; package lang; package boolean; package z; import language.implicitConversions
...
object opt:
  ...
  inline def mix[A<:Raw,B,C](x:G.Opt[A], bo: Any.Opt[B], inline f: (A,B)=>C)(using inline C: Specialized[C]): C.Opt =
    ...
    inline C match
      ...
      case _                                => { var o:  Val.Opt[C]= \/; if(x && bo.SOME) o=f(x.`val`,bo.VAL).cast[C      ]; o.cast[C.Opt] }
