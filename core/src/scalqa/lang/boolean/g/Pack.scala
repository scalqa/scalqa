...
object Pack:
  ...
  @tn("getVoid")  inline def void      [A<:Raw]                            : Pack[A] = z_Void.cast[Pack[A]]; object z_Void extends Pack(Array.emptyBoolean) with Gen.Void
...
___________________________________________________________________________*/
/**
@class Pack -> ### Boolean Specialized Generic Pack Collection
