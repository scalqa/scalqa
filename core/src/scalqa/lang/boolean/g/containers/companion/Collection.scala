package scalqa; package lang; package boolean; package g; package containers; package companion; import language.implicitConversions
...
private[scalqa] object Collection extends Collection[Boolean]
