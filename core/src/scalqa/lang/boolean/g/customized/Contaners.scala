package scalqa; package lang; package boolean; package g; package customized; import language.implicitConversions
...
transparent trait Containers[A<:Raw]:
  ...
  /**/                                                                val Fun        = companion.Fun       .cast[companion.Fun[A]]
  /**/          type StableSet    = Val.Collection.StableSet[A];      def StableSet  = Val.Collection.StableSet

  inline def emptyArray: Array[A] = ZZ.emptyBooleanArray.cast[Array[A]]
...
___________________________________________________________________________*/
/**
@trait Containers -> ### Boolean Generic Type Assigened Containers
...
@type StableSet  ->  Type alias \n\n Shortcut to [[scalqa.lang.Boolean$.Collection.StableSet Collection.StableSet]]
