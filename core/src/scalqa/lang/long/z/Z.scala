...
object  Z:
  ...
  object OptEmptyDef extends Any.Def.Void[G.Opt[Long]] with Any.Def.Empty[G.Opt[Long]]:
    def value_isVoid( v:G.Opt[Long]) = v.isEmpty
    def value_isEmpty(v:G.Opt[Long]) = v.isEmpty
