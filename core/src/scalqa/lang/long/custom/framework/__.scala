...
transparent trait Framework[A<:RAW]:
  ...
  inline def emptyArray: Array[A] = ZZ.emptyLongArray.cast[Array[A]]
...
___________________________________________________________________________*/
/**
@trait Framework -> ### Raw Long Customized Containers
...
@type StableSet  ->  Type alias \n\n Shortcut to [[scalqa.lang.Long$.Collection.StableSet Collection.StableSet]]
