package scalqa; package lang; package long; package g; package containers; package companion; import language.implicitConversions
...
private[scalqa] object Collection extends Collection[Long]
