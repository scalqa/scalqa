...
object Lookup:
  ...
  object Stable:
    ...
    @tn("getVoid")  def void[A<:Raw,B]                   : Stable[A,B] = zVoid.cast[Stable[A,B]]; private object zVoid extends Stable(LongMap.empty) with Gen.Void
    implicit inline def implicitFrom[A<:Raw,B](inline v: \/): Stable[A,B] = void
