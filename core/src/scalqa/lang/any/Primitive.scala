...
object Primitive:
  ...
  @tn("Stream")type ~[A]          = byte.G.~         [A&Byte] | char.G.~         [A&Char] | short.G.~         [A&Short] | int.G.~         [A&Int] | long.G.~         [A&Long] | float.G.~         [A&Float] | double.G.~         [A&Double] | boolean.G.~         [A&Boolean]
  @tn("Pack")  type ><[A]         = byte.G.><        [A&Byte] | char.G.><        [A&Char] | short.G.><        [A&Short] | int.G.><        [A&Int] | long.G.><        [A&Long] | float.G.><        [A&Float] | double.G.><        [A&Double] | boolean.G.><        [A&Boolean]
  @tn("Range") type <>[A]         = byte.G.<>        [A&Byte] | char.G.<>        [A&Char] | short.G.<>        [A&Short] | int.G.<>        [A&Int] | long.G.<>        [A&Long] | float.G.<>        [A&Float] | double.G.<>        [A&Double] | Val.<>              [A&Boolean]
