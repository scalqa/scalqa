...
object X:
  ...
  class Boolean[A<:Any.Boolean] extends Primitive[A]:
    ...
    @tn("Range")  type <> = Val.<>           [A&Any.Boolean]; type Opt = lang.boolean.G.Opt[A&Any.Boolean]; type Collection = lang.boolean.G.Collection [A&Any.Boolean]
    @tn("Pack")   type >< = lang.boolean.G.><[A&Any.Boolean]; type Pro = lang.boolean.G.Pro[A&Any.Boolean]; type Buffer     = lang.boolean.G.Buffer     [A&Any.Boolean]
