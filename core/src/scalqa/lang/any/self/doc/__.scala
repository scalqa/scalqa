package scalqa; package lang; package any; package self; import doc.*; import language.implicitConversions
...
@class Doc -> ### Instance Documentation

    [[Doc]] is a buffer of (name,value) tuples, describing all instance properties
