package scalqa; package lang; package short; package g; package containers; package companion; import language.implicitConversions
...
private[scalqa] object Collection extends Collection[Short]
