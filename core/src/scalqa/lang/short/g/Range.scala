...
class Range[A<:Raw](_start: A, _size: Int) extends Val.<>[A] with Able.Size with Able.~[A] with any.z.PrimitiveTag.Short:
  ...
  /**/              def ordering               : Ordering[A]   = Short.ordering.cast[Gen.Ordering[A]]
...
___________________________________________________________________________*/
/**
@class Range -> ### Short Specialized Generic Range
