...
object Numerical:
  ...
  transparent trait _methods extends Data._methods with Ordered.zMethodsBase:
    extension[THIS_OPAQUE <: Opaque](inline x: THIS_OPAQUE)
      ...
      @tn("multiply")       inline def * (inline v: THIS_OPAQUE|Byte|Short)                      : THIS_OPAQUE     = (x.real * v.cast[Short]).cast[THIS_OPAQUE]
      @tn("divide")         inline def / (inline v: THIS_OPAQUE|Byte|Short)                      : THIS_OPAQUE     = (x.real / v.cast[Short]).cast[THIS_OPAQUE]
      @tn("plus")           inline def + (inline v: THIS_OPAQUE|Byte|Short)                      : THIS_OPAQUE     = (x.real + v.cast[Short]).cast[THIS_OPAQUE]
      @tn("minus")          inline def - (inline v: THIS_OPAQUE|Byte|Short)                      : THIS_OPAQUE     = (x.real - v.cast[Short]).cast[THIS_OPAQUE]
      @tn("remainder")      inline def % (inline v: THIS_OPAQUE|Byte|Short)                      : THIS_OPAQUE     = (x.real % v.cast[Short]).cast[THIS_OPAQUE]
      @tn("greater")        inline def > (inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean         = inline v match{ case _ :Double => x.real >  v.cast[Double]; case _ :Float => x.real >  v.cast[Float]; case _ :Long => x.real >  v.cast[Long]; case _ :Int => x.real >  v.cast[Int]; case _ => x.real >  v.cast[Short] }
      @tn("greaterOrEqual") inline def >=(inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean         = inline v match{ case _ :Double => x.real >= v.cast[Double]; case _ :Float => x.real >= v.cast[Float]; case _ :Long => x.real >= v.cast[Long]; case _ :Int => x.real >= v.cast[Int]; case _ => x.real >= v.cast[Short] }
      @tn("less")           inline def < (inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean         = inline v match{ case _ :Double => x.real <  v.cast[Double]; case _ :Float => x.real <  v.cast[Float]; case _ :Long => x.real <  v.cast[Long]; case _ :Int => x.real <  v.cast[Int]; case _ => x.real <  v.cast[Short] }
      @tn("lessOrEqual")    inline def <=(inline v: THIS_OPAQUE|Byte|Short|Int|Long|Float|Double): Boolean         = inline v match{ case _ :Double => x.real <= v.cast[Double]; case _ :Float => x.real <= v.cast[Float]; case _ :Long => x.real <= v.cast[Long]; case _ :Int => x.real <= v.cast[Int]; case _ => x.real <= v.cast[Short] }
      ...
      /**/                  inline def toShort                                                   : Short           = x.real
...
___________________________________________________________________________*/
/**
@class Numerical -> ### Short Opaque Numerical Data Companion Object Base
