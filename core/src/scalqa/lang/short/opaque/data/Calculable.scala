...
@class Calculable -> ### Short Opaque Calculable Data Companion Object Base
  ...
  See [sample type definition](https://github.com/scalqa/samples/blob/master/src/example/opaque/all/CalculableShortData.scala).

@trait _methods -> Default methods for all Short.Opaque.Data.Calculable defined types
