...
import any.ref.custom.framework.{ companion as REF }

transparent trait Framework[A<:RAW]:
  ...
  /**/          type Lookup[B]    = G.Lookup[A,B];                    final  val Lookup     = C.Lookup    .cast[C.Lookup[A]]
  ...
  /**/          type StableSet    = G.Collection.StableSet[A];        inline def StableSet  = C.Collection.StableSet

  inline def emptyArray: Array[A] = ZZ.emptyShortArray.cast[Array[A]]

object Framework:
  inline def Companion = framework.Companion
...
___________________________________________________________________________*/
/**
@trait Framework -> ### Raw Short Customized Containers
...
@type StableSet  ->  Type alias \n\n Shortcut to [[scalqa.lang.Short$.Collection.StableSet Collection.StableSet]]
