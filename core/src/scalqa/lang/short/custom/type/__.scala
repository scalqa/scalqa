...
abstract class Type[A<:Opaque.Short](val typeName:String) extends Opaque.Companion[A](ClassTag.Short.cast[ClassTag[A]]) with gen.`given`.VoidTag.RawShort[A] with Type._methods[A]:
