package scalqa; package lang; package short; package custom;  package containers; package companion; import language.implicitConversions
...
object Lookup extends Lookup[SELF]
