...
import java.lang.{ Short as NUMBER }

abstract class Number[A<:Opaque.Short](typeName:String) extends Ordered[A](typeName):
  ...
  extension[A<:RAW](inline x: A)
    ...
    @tn("numberMultiply")       inline def * (inline v: A|Byte|Short)                         : A           = (x.real * v.cast[Short]).cast[A]
    @tn("numberDivide")         inline def / (inline v: A|Byte|Short)                         : A           = (x.real / v.cast[Short]).cast[A]
    @tn("numberPlus")           inline def + (inline v: A|Byte|Short)                         : A           = (x.real + v.cast[Short]).cast[A]
    @tn("numberMinus")          inline def - (inline v: A|Byte|Short)                         : A           = (x.real - v.cast[Short]).cast[A]
    @tn("numberRemainder")      inline def % (inline v: A|Byte|Short)                         : A           = (x.real % v.cast[Short]).cast[A]
    @tn("numberGreater")        inline def > (inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real >  v.cast[Double]; case _ :Float => x.real >  v.cast[Float]; case _ :Long => x.real >  v.cast[Long]; case _ :Int => x.real >  v.cast[Int]; case _ => x.real >  v.cast[Short] }
    @tn("numberGreaterOrEqual") inline def >=(inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real >= v.cast[Double]; case _ :Float => x.real >= v.cast[Float]; case _ :Long => x.real >= v.cast[Long]; case _ :Int => x.real >= v.cast[Int]; case _ => x.real >= v.cast[Short] }
    @tn("numberLess")           inline def < (inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real <  v.cast[Double]; case _ :Float => x.real <  v.cast[Float]; case _ :Long => x.real <  v.cast[Long]; case _ :Int => x.real <  v.cast[Int]; case _ => x.real <  v.cast[Short] }
    @tn("numberLessOrEqual")    inline def <=(inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real <= v.cast[Double]; case _ :Float => x.real <= v.cast[Float]; case _ :Long => x.real <= v.cast[Long]; case _ :Int => x.real <= v.cast[Int]; case _ => x.real <= v.cast[Short] }
