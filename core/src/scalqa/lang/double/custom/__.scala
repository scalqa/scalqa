...
object Custom:
  type Type[A<:Opaque.Double] = custom.Type[A];        transparent inline def Type       = custom.Type
  type Data[A<:Opaque.Double] = custom.Data[A];        transparent inline def Data       = custom.Data
