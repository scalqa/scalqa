...
abstract class Type[A<:Opaque.Double](val typeName:String) extends Opaque.Companion[A](ClassTag.Double.cast[ClassTag[A]]) with gen.`given`.VoidTag.RawDouble[A] with Type._methods[A]:
...
___________________________________________________________________________*/
/**
@class Type -> ### Double Custom Type Setup
