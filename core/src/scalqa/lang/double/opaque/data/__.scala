...
___________________________________________________________________________*/
/**
@class Data -> ### Double Opaque Data Companion Base
  ...
  See [sample type definition](https://github.com/scalqa/samples/blob/master/src/example/opaque/all/DoubleData.scala).

@trait _methods -> Default methods for all Double.Opaque.Data defined types
