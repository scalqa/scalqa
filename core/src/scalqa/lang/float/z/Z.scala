...
object  Z:
  ...
  object OptEmptyDef extends Any.Def.Void[G.Opt[Float]] with Any.Def.Empty[G.Opt[Float]]:
    def value_isVoid( v:G.Opt[Float]) = v.isEmpty
    def value_isEmpty(v:G.Opt[Float]) = v.isEmpty
