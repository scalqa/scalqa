...
import java.lang.{ Float as NUMBER }

abstract class Number[A<:Opaque.Float](typeName:String) extends Ordered[A](typeName):
  ...
  extension[A<:RAW](inline x: A)
    ...
    @tn("numberMultiply")       inline def * (inline v: A|Byte|Short|Int|Long|Float)          : A           = (x.real * v.cast[Float]).cast[A]
    @tn("numberDivide")         inline def / (inline v: A|Byte|Short|Int|Long|Float)          : A           = (x.real / v.cast[Float]).cast[A]
    @tn("numberPlus")           inline def + (inline v: A|Byte|Short|Int|Long|Float)          : A           = (x.real + v.cast[Float]).cast[A]
    @tn("numberMinus")          inline def - (inline v: A|Byte|Short|Int|Long|Float)          : A           = (x.real - v.cast[Float]).cast[A]
    @tn("numberRemainder")      inline def % (inline v: A|Byte|Short|Int|Long|Float)          : A           = (x.real % v.cast[Float]).cast[A]
    @tn("numberGreater")        inline def > (inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real >  v.cast[Double]; case _ => x.real >  v.cast[Float] }
    @tn("numberGreaterOrEqual") inline def >=(inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real >= v.cast[Double]; case _ => x.real >= v.cast[Float] }
    @tn("numberLess")           inline def < (inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real <  v.cast[Double]; case _ => x.real <  v.cast[Float] }
    @tn("numberLessOrEqual")    inline def <=(inline v: A|Byte|Short|Int|Long|Float|Double)   : Boolean     = inline v match{ case _ :Double => x.real <= v.cast[Double]; case _ => x.real <= v.cast[Float] }
