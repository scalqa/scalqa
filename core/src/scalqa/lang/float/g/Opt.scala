...
object Opt:
  ...
  implicit       inline def implicitFromAnyFloat[A<:Raw](inline v: A)         : Opt[A]     = v.cast[Opt[A]]
  ...
  extension[A<:Raw](inline x: Opt[A])
    ...
    /**/  inline def ref                                         : Val.Opt[A] = {val X=x; if(X.isEmpty) ZZ.None else java.lang.Float.valueOf(X.real)}.cast[Val.Opt[A]]
    /**/  inline def isEmpty                                     : Boolean    = java.lang.Float.isNaN(x.real)
    /**/  inline def nonEmpty                                    : Boolean    = java.lang.Float.isNaN(x.real).not
  ...
  object TYPE:
    opaque type DEF[+A<:Raw] <: Float.Opaque = Float.Opaque
...
___________________________________________________________________________*/
/**
@type DEF -> ### Float Specialized Generic Option
