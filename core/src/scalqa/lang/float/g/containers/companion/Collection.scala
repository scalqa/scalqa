package scalqa; package lang; package float; package g; package containers; package companion; import language.implicitConversions
...
private[scalqa] object Collection extends Collection[Float]
