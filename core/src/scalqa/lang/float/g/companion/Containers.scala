package scalqa; package lang; package float; package g; package companion; import language.implicitConversions
...
transparent trait Containers[BASE_TYPE<:Raw]:
  ...
  type Lookup[B]    = Val.Lookup[BASE_TYPE,B];    val Lookup     = REF.Z.Lookup    .cast[REF.Lookup[BASE_TYPE]]
  ...
  type Set          = Val.Set[BASE_TYPE];         def Set        = REF.Z.Set       .cast[REF.Set[BASE_TYPE]]
