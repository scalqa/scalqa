...
object Calculable:
  ...
  transparent trait _methods extends Ordered._methods:
    extension[THIS_OPAQUE <: Opaque](inline x: THIS_OPAQUE)
      ...
      @tn("multiply") inline def *(inline v: Byte|Short|Int|Long|Float): THIS_OPAQUE  = (x.real * v.cast[Float]).cast[THIS_OPAQUE]
      @tn("divide")   inline def /(inline v: Byte|Short|Int|Long|Float): THIS_OPAQUE  = (x.real / v.cast[Float]).cast[THIS_OPAQUE]
...
___________________________________________________________________________*/
/**
@class Calculable -> ### Float Opaque Calculable Data Companion Object Base
