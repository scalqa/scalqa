...
private[scalqa] class Entry(chld: Entry, val `type`: AnyRef, protected[z] var cargo: Any) extends AtomicReference[Entry](chld) with Trigger with store.Entry with scalqa.gen.event.Control:
