...
object Percent extends Double.Opaque.Data.Numerical[Percent]("Percent"):
  ...
  extension(inline x: Percent)
    ...
    /**/               inline def apply[A<:Int.Opaque]   (inline nv: A)(using inline n:Numeric[A]): A      =  x(nv.cast[Int]).cast[A]
    /**/               inline def apply[A<:Long.Opaque]  (inline nv: A)(using inline n:Numeric[A]): A      =  x(nv.cast[Long]).cast[A]
    /**/               inline def apply[A<:Float.Opaque] (inline nv: A)(using inline n:Numeric[A]): A      =  x(nv.cast[Float]).cast[A]
    /**/               inline def apply[A<:Double.Opaque](inline nv: A)(using inline n:Numeric[A]): A      =  x(nv.cast[Double]).cast[A]
