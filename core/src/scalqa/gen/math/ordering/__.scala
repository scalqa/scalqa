...
trait Ordering[A] extends scala.math.Ordering[A]:
  ...
  @tn("voidFirst_View") def voidFirst_^(using Def.Void[A]) : ORD[A]      = z.View.VoidPositionFirst[A](this)
  @tn("voidLast_View")  def voidLast_^ (using Def.Void[A]) : ORD[A]      = z.View.VoidPositionLast[A](this)
