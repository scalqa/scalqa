...
transparent trait _Use extends _aggregate with _calculate with _evaluate with _metadata with _print with _process with _read with _Transform:
  self =>
...
object _Use:
  ...
  type _transform = _use._Transform;         transparent inline def _transform = _use._Transform
