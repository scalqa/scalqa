...
object FlatMap:
  ...
  abstract class ToBoolean[A<:Any.Raw.Boolean](x: Ref) extends lang.boolean.Z.Pipe[A](x):
  ...
  abstract class ToByte[A<:Any.Raw.Byte](x: Ref) extends lang.byte.Z.Pipe[A](x):
  ...
  abstract class ToChar[A<:Any.Raw.Char](x: Ref) extends lang.char.Z.Pipe[A](x):
  ...
  abstract class ToShort[A<:Any.Raw.Short](x: Ref) extends lang.short.Z.Pipe[A](x):
  ...
  abstract class ToInt[A<:Any.Raw.Int](x: Ref) extends lang.int.Z.Pipe[A](x):
  ...
  abstract class ToLong[A<:Any.Raw.Long](x: Ref) extends lang.long.Z.Pipe[A](x):
  ...
  abstract class ToFloat[A<:Any.Raw.Float](x: Ref) extends lang.float.Z.Pipe[A](x):
  ...
  abstract class ToDouble[A<:Any.Raw.Double](x: Ref) extends lang.double.Z.Pipe[A](x):
