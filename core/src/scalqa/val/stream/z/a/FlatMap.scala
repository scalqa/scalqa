...
object FlatMap:
  ...
  abstract class ToBoolean[A<:Boolean.Raw](x: AnyRef) extends lang.boolean.Z.Pipe[A](x):
  ...
  abstract class ToByte[A<:Byte.Raw](x: AnyRef) extends lang.byte.Z.Pipe[A](x):
  ...
  abstract class ToChar[A<:Char.Raw](x: AnyRef) extends lang.char.Z.Pipe[A](x):
  ...
  abstract class ToShort[A<:Short.Raw](x: AnyRef) extends lang.short.Z.Pipe[A](x):
  ...
  abstract class ToInt[A<:Int.Raw](x: AnyRef) extends lang.int.Z.Pipe[A](x):
  ...
  abstract class ToLong[A<:Long.Raw](x: AnyRef) extends lang.long.Z.Pipe[A](x):
  ...
  abstract class ToFloat[A<:Float.Raw](x: AnyRef) extends lang.float.Z.Pipe[A](x):
  ...
  abstract class ToDouble[A<:Double.Raw](x: AnyRef) extends lang.double.Z.Pipe[A](x):
