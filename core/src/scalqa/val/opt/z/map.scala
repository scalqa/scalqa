...
object map:
  ...
  inline def apply[A,B,OPT<:Opt.AnyType[B]](x:Opt[A], inline f: A=>B, inline s:OptShape[B,OPT] ): OPT =
    inline s match
      ...
      case _ : OptShape[B,AnyRef .G.Opt[B]] => {var o:      Val.Opt[B              ]= \/; if(x.nonEmpty) o=f(x.`val`).cast[B              ]; o.cast[OPT]}
