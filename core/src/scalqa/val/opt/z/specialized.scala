...
object specialized:
  ...
  inline def mix[A,B,C](x:Opt[A], bo: Any.Opt[B], inline f: (A,B) => C)(using inline C:Specialized[C]): C.Opt =
    ...
    inline C match
      ...
      case _                                => { var o:  Val.Opt[C]=VOID;if(x && bo.SOME) o=f(x.`val`,bo.VAL)              ; o.cast[C.Opt]}

  inline def raw[A](x:Opt[A])(using inline A:Specialized.Primitive[A]): A.Opt =
    inline A match
      case _ : Specialized.Primitive[A & Any.Boolean] => {var o: Boolean.Opt=VOID;if(x) o=x.cast[java.lang.Boolean  ].booleanValue; o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Byte   ] => {var o: Byte   .Opt=VOID;if(x) o=x.cast[java.lang.Byte     ].byteValue;    o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Char   ] => {var o: Char   .Opt=VOID;if(x) o=x.cast[java.lang.Character].charValue;    o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Short  ] => {var o: Short  .Opt=VOID;if(x) o=x.cast[java.lang.Short    ].shortValue;   o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Int    ] => {var o: Int    .Opt=VOID;if(x) o=x.cast[java.lang.Integer  ].intValue;     o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Long   ] => {var o: Long   .Opt=VOID;if(x) o=x.cast[java.lang.Long     ].longValue;    o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Float  ] => {var o: Float  .Opt=VOID;if(x) o=x.cast[java.lang.Float    ].floatValue;   o.cast[A.Opt]}
      case _ : Specialized.Primitive[A & Any.Double ] => {var o: Double .Opt=VOID;if(x) o=x.cast[java.lang.Double   ].doubleValue;  o.cast[A.Opt]}
