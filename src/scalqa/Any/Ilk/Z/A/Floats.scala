...
private[Ilk] object Floats extends Base[Float] {
  ...
  @inline def mkMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, B]) = Stream.Z.extend.map.map.primRef[Float, B](s.asInstanceOf[Stream[Float]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Float, B]], Refs).asInstanceOf[Stream[B]]
  ...
  @inline def mkFlatMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, ~[B]]) = Stream.Z.extend.map.flatMap.primRef[Float, B](s.asInstanceOf[Stream[Float]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Float, ~[B]]], Refs).asInstanceOf[Stream[B]]
  ...
  @inline def mkLetMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, Opt[B]]) = Stream.Z.extend.filter.letMap.primRef[Float, B](s.asInstanceOf[Stream[Float]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Float, Opt[B]]], Refs).asInstanceOf[Stream[B]]
