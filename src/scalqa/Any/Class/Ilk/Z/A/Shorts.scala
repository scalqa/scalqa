...
private[Ilk] object Shorts extends Base[Short] {
  ...
  @inline def mkMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, B]) = Stream.Z.extend.map.map.primRef[Short, B](s.asInstanceOf[Stream[Short]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Short, B]], Objects).asInstanceOf[Stream[B]]
  ...
  @inline def mkFlatMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, ~[B]]) = Stream.Z.extend.map.flatMap.primRef[Short, B](s.asInstanceOf[Stream[Short]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Short, ~[B]]], Objects).asInstanceOf[Stream[B]]
  ...
  @inline def mkLetMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, Opt[B]]) = Stream.Z.extend.filter.letMap.primRef[Short, B](s.asInstanceOf[Stream[Short]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Short, Opt[B]]], Objects).asInstanceOf[Stream[B]]
