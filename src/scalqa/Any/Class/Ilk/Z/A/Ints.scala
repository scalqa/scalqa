...
private[scalqa] object Ints extends Base[Int] {
  ...
  @inline def mkMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, B]) = Stream.Z.extend.map.map.primRef[Int, B](s.asInstanceOf[Stream[Int]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Int, B]], Objects).asInstanceOf[Stream[B]]
  ...
  @inline def mkFlatMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, ~[B]]) = Stream.Z.extend.map.flatMap.primRef[Int, B](s.asInstanceOf[Stream[Int]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Int, ~[B]]], Objects).asInstanceOf[Stream[B]]
  ...
  @inline def mkLetMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, Opt[B]]) = Stream.Z.extend.filter.letMap.primRef[Int, B](s.asInstanceOf[Stream[Int]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Int, Opt[B]]], Objects).asInstanceOf[Stream[B]]
