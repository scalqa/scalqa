...
private[Ilk] object Longs extends Base[Long] {
  ...
  @inline def mkMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, B]) = Stream.Z.extend.map.map.primRef[Long, B](s.asInstanceOf[Stream[Long]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Long, B]], Objects).asInstanceOf[Stream[B]]
  ...
  @inline def mkFlatMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, ~[B]]) = Stream.Z.extend.map.flatMap.primRef[Long, B](s.asInstanceOf[Stream[Long]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Long, ~[B]]], Objects).asInstanceOf[Stream[B]]
  ...
  @inline def mkLetMapIlkRef[A, B](s: Stream[A], f: Stream.Mapping[A, Opt[B]]) = Stream.Z.extend.filter.letMap.primRef[Long, B](s.asInstanceOf[Stream[Long]], f.asInstanceOf[Stream.Mapping.Z.PrimRef[Long, Opt[B]]], Objects).asInstanceOf[Stream[B]]
